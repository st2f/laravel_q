  ...
  (page) => {
    ...
    return createInertiaApp({
      ...
      resolve: (name) => resolvePageComponent(
        `./pages/${name}.vue`,
        /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-BzP622ND.js"), "./pages/Welcome.vue": () => import("./assets/Welcome-Dr-7jBvn.js"), "./pages/auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-BZ26N-Eb.js"), "./pages/auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-Cxt0F-sH.js"), "./pages/auth/Login.vue": () => import("./assets/Login-Cl0xRpE6.js"), "./pages/auth/Register.vue": () => import("./assets/Register-BdgEhAhG.js"), "./pages/auth/ResetPassword.vue": () => import("./assets/ResetPassword-CXyokr8f.js"), "./pages/auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-B4K9It74.js"), "./pages/settings/Appearance.vue": () => import("./assets/Appearance-_PJ8e5QO.js"), "./pages/settings/Password.vue": () => import("./assets/Password-WvkSUJRC.js"), "./pages/settings/Profile.vue": () => import("./assets/Profile-C1Dfy5J0.js") })
      ),
